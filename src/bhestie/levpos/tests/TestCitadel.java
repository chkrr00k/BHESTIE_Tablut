...
public class TestCitadel {
	...
	public void testCitadel() {
		...
		positions.add(Position.of(5, 1));
		positions.add(Position.of(4, 1));
		positions.add(Position.of(6, 1));
		positions.add(Position.of(5, 2));
		Citadel c = new Citadel(positions);
		
		assertTrue(c.isXYInCitadel(4, 1));
		assertTrue(c.isPositionInCitadel(Position.of(5, 1)));
